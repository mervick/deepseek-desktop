...
The tab bridge in `api/deepseek.ts` syncs tab IDs/state, passes measured bounds, and subscribes to native view ready/load-error events. It does not expose `WebContents` or raw Electron objects.
